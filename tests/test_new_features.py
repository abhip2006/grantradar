...
class TestSeasonalAnalysis:
    ...
    def test_identify_peak_months(self):
        ...
        monthly_data = {
            1: 15, 2: 12, 3: 20, 4: 10, 5: 8, 6: 6,
            7: 5, 8: 4, 9: 8, 10: 12, 11: 15, 12: 10
        }
...
class TestSimilarityService:
    ...
    def test_category_overlap_score(self):
        ...
        score1 = category_overlap(
            ["ml", "healthcare", "ai"],
            ["ml", "healthcare", "data_science"]
        )
        assert score1 > 0.4

        score2 = category_overlap(
            ["ml", "healthcare"],
            ["geology", "archaeology"]
        )
        assert score2 == 0
    ...
    def test_extract_research_areas(self):
        ...
        def extract_research_areas(text: str) -> list[str]:
            keywords = [
                ...
                "natural language processing", "computer vision", "healthcare",
                "genomics", "climate", "neuroscience"
            ]
