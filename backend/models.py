...
class GrantMechanism(Base):
    """
    Grant mechanism metadata with success rates and review criteria.

    Stores detailed information about each grant mechanism including
    historical success rates, typical budgets, and review criteria
    to help researchers understand competition levels.
    """
    ...
    code: Mapped[str] = mapped_column(
        ...
        nullable=False,
        unique=True,
        doc="Mechanism code (e.g., R01, R21, K01)",
    )
    name: Mapped[str] = mapped_column(
        Text,
        nullable=False,
        doc="Full mechanism name",
    )
    description: Mapped[Optional[str]] = mapped_column(
        Text,
        nullable=True,
    ...
    success_rate_renewal: Mapped[Optional[float]] = mapped_column(
        Float,
        nullable=True,
        doc="Success rate for renewals (0.0 to 1.0)",
    )
    success_rate_resubmission: Mapped[Optional[float]] = mapped_column(
        Float,
        nullable=True,
        doc="Success rate for resubmissions (0.0 to 1.0)",
    )
    ...
    competition_level: Mapped[Optional[str]] = mapped_column(
        Text,
        nullable=True,
        doc="Competition level (low, medium, high, very_high)",
    )
    estimated_applicants_per_cycle: Mapped[Optional[int]] = mapped_column(
        Integer,
        nullable=True,
        doc="Estimated number of applicants per review cycle",
    )
    review_criteria: Mapped[Optional[dict[str, Any]]] = mapped_column(
        JSONB,
        nullable=True,
        doc="Structured review criteria and weights",
    )
    ...
    tips: Mapped[Optional[dict[str, Any]]] = mapped_column(
        JSONB,
        nullable=True,
        doc="Array of tips for applicants",
    )
    ...
    def __repr__(self) -> str:
        return f"<GrantMechanism(id={self.id}, code='{self.code}', success_rate={self.success_rate_overall})>"
