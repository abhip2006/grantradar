...
class TestLLMEvaluation:
    ...
    @patch("agents.matching.matcher.anthropic")
    def test_evaluate_matches_batch_json_error(self, mock_anthropic, mock_db_engine, grant_data_full, profile_match):
...
class TestPriorityComputation:
    ...
    def test_critical_priority_high_score_urgent(self, mock_db_engine):
        ...
        deadline = datetime.now(timezone.utc).replace(hour=0, minute=0, second=0, microsecond=0)
